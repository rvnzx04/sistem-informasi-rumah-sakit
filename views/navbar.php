...
<head>
    ...
    <!-- jquery -->
    <script src="views/jquery-1.12.4.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    <script src="views/JsLocalSearch.js"></script>
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="data-berobat.php">
                <i class="bi bi-journal-medical"></i>
                    <span>Tambah Berobat</span></a>
            </li>
            <li class="nav-item">
            ...
            <?php
                        $select_rows = mysqli_query($conn, "SELECT * FROM tambah_rm WHERE tindakan='Rawat Inap';") or die('query failed');
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-truck-flatbed"></i>
                    <span>Rawat Inap</span> <span class="btn btn-danger btn-sm"><?= $row_count ?></span></a>
            </li>
