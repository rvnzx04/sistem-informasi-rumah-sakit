                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-bordered">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <td colspan="6">
                                                        <th class="text-center"><a href="transaksi_inap.php?transaksi=<?php echo $id ?>" class="btn btn-primary "><i class="bi bi-check-lg"></i> Selesai</a></th>
                                                    </tr>
                                                    <?php } ?>
