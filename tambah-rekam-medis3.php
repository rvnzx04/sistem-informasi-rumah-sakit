...
if (isset($_GET['added'])) {
    $id_pb = $_GET['added'];
    $query = "SELECT * FROM berobat2 WHERE id_pasienberobat ='$id_pb';";
    $sql = mysqli_query($conn, $query);
    $result = mysqli_fetch_assoc($sql);
    $name = $result['nama_pasien'];
                            ...
                            <form method="POST" action="proses.php" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="id_pb" value="<?= $id_pb; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                                <input type="text" class="form-control" name="nama" placeholder="" value="<?= $name; ?>" readonly>
                                            <?php
                                            endif;
                                            ?>
                                        </div>
                                    ...
                                    <button type="submit" name="aksi5" class="btn btn-primary btn-fill pull-right float-right ms-2 " style="float:right;" value="addd">Tambahkan</button>
