...
if (isset($_GET['proses'])) {
    $id = $_GET['proses'];
    $query = "SELECT * FROM tambah_rm3  WHERE id_rm2 ='$id';";
                        ...
                        <div class="content">
                            ...
                            <form method="POST" action="proses.php" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <h2></h2>
                                    <span>Resep Obat : <?= $resep; ?></span>
                                    <h2></h2>
                                    <span>Tindakan : <?= $tindakan; ?></span>
                                    <h2></h2>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-bordered">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <?php
                                                    if($tindakan == 'Rawat Jalan' or $tindakan == 'Pulang'){?>
                                                    <tr>
                                                        <td colspan="6">
                                                        <th class="text-center"><a href="transaksi.php?transaksi2=<?php echo $id ?>" class="btn btn-primary "><i class="bi bi-check-lg"></i> Selesai</a></th>
                                                    </tr>
                                                    <?php }  ?>
