...
INSERT INTO `berobat` (`id_pasienberobat`, `nama_pasien`, `spesialis`, `tanggal`, `status`) VALUES
(10, 'higa', 7, '2023/01/19', 'selesai'),
(11, 'fardan', 4, '2023/02/08', 'selesai'),
(12, 'fardan', 4, '2023/02/08', 'selesai');
...
--
-- Dumping data for table `berobat2`
--

INSERT INTO `berobat2` (`id_pasienberobat`, `id_user`, `nama_pasien`, `spesialis`, `tanggal`, `status`) VALUES
(11, 18, 'rian', 4, '2023/01/28', 'selesai'),
(12, 19, 'aufa', 7, '2023/01/28', 'selesai'),
(13, 19, 'aufa', 6, '2023/01/28', 'selesai'),
(14, 19, 'Fardan', 7, '2023/02/01', 'selesai'),
(15, 19, 'fardan agung setiawan', 7, '2023-02-02', 'pending'),
(16, 19, 'fardan agung setiawan', 7, '2023-02-02', 'selesai'),
(17, 19, 'fardan agung setiawan', 7, '2023-02-02', 'selesai'),
(18, 18, 'rian', 7, '2023-02-23', 'selesai');
...
(53, 'KMR002', 'higa', 3, 'Rp.300.000', '1', '2023-01-15', 'selesai'),
...
(44, 18, 'P-001', '123', 'rian', 7, '2023-02-23', 'berobat', 'selesai', '62895385309904');
...
(42, 19, '123456789', 'aufa', 'cirebon, 1 september 1990', 'Laki Laki', '', '', '62895385309904', '', '2023-01-28'),
(43, 18, '1111', 'y', 'cirebon, 1 september 1990', 'Laki Laki', '', '', '56656565', '', '2023-01-30'),
(44, 19, '2121212', 'Fardan', '2023-02-01', 'Laki Laki', '', '', '628478574854875', '', '2023-02-01'),
(45, 19, '11222', 'fardan agung setiawan', '2023-02-03', 'Laki Laki', '', '', '62864767476456', '', '2023-02-02');
...
(66, 53, 'higa', 7, '2023/01/19', 'menginap', 'pending'),
...
(74, 53, 'higa', 'xx', 'xx', 'xx', 'Pulang', '2023-01-19', 'selesai'),
(75, 54, 'higa', 'aa', 'bb', 'xx', 'Rawat Jalan', '2023-02-23', 'pending');
...
--
-- Dumping data for table `tambah_rm2`
--

INSERT INTO `tambah_rm2` (`id_rm2`, `nama_ps`, `keluhan_ps`, `diagnosis_ps`, `resep_obat`, `tindakan`, `tanggal`, `status`) VALUES
(11, 'higa', 'aa', 'bb', 'cc', 'Pulang', '2023-01-19', 'pending'),
(12, 'higa', 'aa', 'bb', 'cc', 'Rawat Inap', '2023-01-19', 'selesai'),
(13, 'rian', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-01-28', 'pending'),
(14, 'rian', 'sakit pinggang', 'skoliosis', 'aa', 'Rawat Jalan', '2023-01-28', 'pending'),
(15, 'higa', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-01-28', 'pending'),
(16, 'fardan', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-02-08', 'pending'),
(17, 'fardan', 'y', 'y', 'y', 'Rawat Jalan', '2023-02-08', 'selesai');
...
--
-- Dumping data for table `tambah_rm3`
--

INSERT INTO `tambah_rm3` (`id_rm2`, `id_user`, `nama_ps`, `keluhan_ps`, `diagnosis_ps`, `resep_obat`, `tindakan`, `tanggal`, `status`) VALUES
(17, 19, 'aufa', 'sakit pinggang', 'skoliosis', 'aa', 'Rawat Jalan', '2023-01-28', 'pending'),
(18, 19, 'aufa', 'capek', 'kecapean', 'aa', 'Rawat Jalan', '2023-01-28', 'pending'),
(19, 19, 'Fardan', 'sakit perut dibagian samping', 'usus buntu', 'aa,bb', 'Rawat Jalan', '2023-02-01', 'pending'),
(20, 19, 'fardan agung setiawan', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-02-02', 'pending'),
(21, 19, 'fardan agung setiawan', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-02-08', 'pending'),
(22, 19, 'fardan agung setiawan', 'aa', 'aa', 'aa', 'Rawat Inap', '2023-02-10', 'pending'),
(23, 18, 'rian', 'aa', 'bb', 'cc', 'Rawat Jalan', '2023-02-23', 'pending');
...
--
ALTER TABLE `berobat`
  MODIFY `id_pasienberobat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `berobat2`
--
ALTER TABLE `berobat2`
  MODIFY `id_pasienberobat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `data_obat`
--
ALTER TABLE `data_obat`
  MODIFY `id_obat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;

--
-- AUTO_INCREMENT for table `kamar`
--
ALTER TABLE `kamar`
  MODIFY `id_kamar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `tambah_berobat`
  MODIFY `id_berobat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `tambah_berobat2`
--
ALTER TABLE `tambah_berobat2`
  MODIFY `id_berobat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `tambah_pb`
  MODIFY `id_pb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `tambah_rm`
--
ALTER TABLE `tambah_rm`
  MODIFY `id_rm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `tambah_rm2`
--
ALTER TABLE `tambah_rm2`
  MODIFY `id_rm2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tambah_rm3`
--
ALTER TABLE `tambah_rm3`
  MODIFY `id_rm2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tbl_pendaftaran`
--
ALTER TABLE `tbl_pendaftaran`
  MODIFY `id_pendaftaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
