...
?>
<h1 class="text-center mt fw-bold  mt-4">Data Absensi</h1>
<div class="container">
    <div class="card mt-5">
                        ...
                        <tr>
                          ...
                          <?php elseif ($absensi['keterangan'] == 'Alpa') :
                            ...
                            <td class="text-center">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $no ?>" class="btn btn-sm btn-success text-white">Edit</button>
